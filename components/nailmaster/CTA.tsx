      ...
      <div className="container mx-auto px-5 md:px-10">
        <div className="text-center max-w-[700px] mx-auto">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="#contacts"
              className="inline-flex items-center justify-center px-8 py-4 text-base font-medium rounded-full bg-white text-primary hover:bg-secondary hover:-translate-y-0.5 transition-all"
            >
